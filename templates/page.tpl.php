<div id="wrap">
    <div class="container">
        ...
        <?php if (isset($page['top_featured_left']) || (isset($page['top_featured_right']))): ?>
        <!-- #top_featured -->
        <div id="top-featured" class="sixteen columns clearfix">
            
            <?php if ($page['top_featured_left'] && $page['top_featured_right']) { ?>
            <div class="one_half">
            <?php print render($page['top_featured_left']); ?>
            </div>
            
            <div class="one_half last">
            <?php print render($page['top_featured_right']); ?>
            </div>
            <?php } else { ?>
